...
// contact
 // Add smooth scrolling and ripple effect
...
// Add enhanced hover and scroll animations
...
cards.forEach(card => {
  ...
  card.addEventListener('mouseenter', function() {
      ...
      // Apply custom shadow animation
      this.style.boxShadow = '0 15px 30px rgba(54, 114, 217, 0.15), 0 0 0 rgba(54, 114, 217, 0.05)';
  ...
  card.addEventListener('mouseleave', function() {
      ...
      this.style.boxShadow = '0 8px 20px rgba(0, 0, 0, 0.03)';
...
// Add floating animation to map
const mapContainer = document.querySelector('.map-container');
mapContainer.style.transition = 'all 0.5s cubic-bezier(0.25, 1, 0.5, 1)';
 ...
 const reviews = [
  {
    ...
    rating: 5,
    content: "Absolutely amazing product! It has transformed our workflow and saved us countless hours. The customer support team is also incredibly responsive.",
    date: "May 2, 2025",
  ...
  },
  {
    ...
    rating: 4,
    content: "Great service with intuitive design. It's been a game-changer for our development team. Just a few minor tweaks would make it perfect.",
    date: "April 28, 2025",
    avatar: "/api/placeholder/80/80",
    isNew: false,
    verified: true
  },
  {
    ...
    rating: 5,
    content: "As a small business owner, I was looking for an affordable solution that wouldn't compromise on quality. This exceeded all my expectations!",
    date: "April 25, 2025",
    avatar: "/api/placeholder/80/80",
    isNew: false,
    verified: true
  },
  {
    ...
    rating: 5,
    content: "The analytical capabilities are outstanding. I can generate reports in minutes that used to take me hours. Highly recommended for any data-driven professional.",
    date: "April 20, 2025",
    avatar: "/api/placeholder/80/80",
    isNew: false,
    verified: true
  },
  {
    ...
    rating: 4,
    content: "From a designer's perspective, the attention to detail is impressive. User experience is well thought out, making it accessible for all skill levels.",
    date: "April 15, 2025",
    avatar: "/api/placeholder/80/80",
    isNew: false,
    verified: false
  },
  {
    ...
    rating: 5,
    content: "Managing multiple projects has never been easier. The collaborative features have improved our team communication dramatically.",
    date: "April 10, 2025",
    avatar: "/api/placeholder/80/80",
    isNew: false,
    verified: true
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  let currentIndex = 0;
  let reviewsPerView = calculateReviewsPerView();
  let totalSlides = Math.ceil(reviews.length / reviewsPerView);
  ...
  function renderReviews() {
    ...
    reviews.forEach((review, index) => {
      ...
      let starsHTML = '';
      for (let i = 1; i <= 5; i++) {
        starsHTML += `<div class="star ${i <= review.rating ? '' : 'empty'}">★</div>`;
      }
      
      reviewCard.innerHTML = `
        ${review.isNew ? '<div class="new-review-badge">NEW</div>' : ''}
      ...
      // Animate cards entrance with delay
      setTimeout(() => {
  ...
  function updateSliderPosition() {
    const cardWidth = reviewsContainer.querySelector('.review-card')
      ? reviewsContainer.querySelector('.review-card').offsetWidth + 20 // width + margin
      : 320;
    
    const translateValue = -currentIndex * cardWidth * reviewsPerView;
    reviewsContainer.style.transform = `translateX(${translateValue}px)`;
  }
  
  // Calculate how many reviews to show per view based on screen width
  ...
  prevBtn.addEventListener('click', () => {
    if (currentIndex > 0) {
      ...
      // Elastic bounce effect when at start
      reviewsContainer.style.transform = `translateX(20px)`;
      setTimeout(() => {
        updateSliderPosition();
      }, 300);
    }
  ...
  nextBtn.addEventListener('click', () => {
    if (currentIndex < totalSlides - 1) {
      ...
      // Elastic bounce effect when at end
      const cardWidth = reviewsContainer.querySelector('.review-card').offsetWidth + 20;
      const currentTranslate = -currentIndex * cardWidth * reviewsPerView;
      reviewsContainer.style.transform = `translateX(${currentTranslate - 20}px)`;
      setTimeout(() => {
        updateSliderPosition();
      }, 300);
    }
  ...
  window.addEventListener('resize', () => {
    const newReviewsPerView = calculateReviewsPerView();
    if (newReviewsPerView !== reviewsPerView) {
      reviewsPerView = newReviewsPerView;
      totalSlides = Math.ceil(reviews.length / reviewsPerView);
